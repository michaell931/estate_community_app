...
import 'package:estate_community_app/app/cubit/auth_cubit.dart' as _i8;
...
import 'package:estate_community_app/repositories/news_repository.dart' as _i7;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i7.NewsRepository>(() => _i7.NewsRepository());
    gh.factory<_i8.AuthCubit>(
        () => _i8.AuthCubit(authRepository: gh<_i4.AuthRepository>()));
    gh.factory<_i9.ForumCubit>(
        () => _i9.ForumCubit(forumRepository: gh<_i6.ForumRepository>()));
    gh.factory<_i10.NewsCubit>(
        () => _i10.NewsCubit(newsRepository: gh<_i7.NewsRepository>()));
    return this;
  }
}
